...
If you are evaluating `LiteRT-LM-Apple` for iPhone, iPad, Apple Vision Pro, or Mac, start with the main project README and then use these focused guides depending on what you are trying to do next.

- [Integration Guide](integration-guide.md): how to add the package to an app and what the runtime surface looks like in practice.
