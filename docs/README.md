...
If you are evaluating `LiteRT-LM-Apple`, start with the main project README and then use these focused guides depending on what you are trying to do next.
